...
def check_all_messages(message, ai_string, switch):
    highest_prob_list = {}
...
def get_response(user_input):
    ...
    # Switch: 0 = Normal Operation, 1 = Rule-Based Only, 2 = NLP Only
    switch = 0
    response = check_all_messages(filtered_sentence, user_input, switch)
